...
VL_ATTR_COLD void Vtb___024root___eval_initial__TOP(Vtb___024root* vlSelf) {
    ...
    // Body
    vlSelf->tb__DOT__dut__DOT__input_state[0U] = 0x61707865U;
    vlSelf->tb__DOT__dut__DOT__input_state[1U] = 0x3320646eU;
    vlSelf->tb__DOT__dut__DOT__input_state[2U] = 0x79622d32U;
    vlSelf->tb__DOT__dut__DOT__input_state[3U] = 0x6b206574U;
}
...
#endif
            VL_FATAL_MT("/tmp/chacha20_tbo7KL.sv", 2, "", "Settle region did not converge.");
        }
...
VL_ATTR_COLD void Vtb___024root___ctor_var_reset(Vtb___024root* vlSelf) {
    ...
    for (int __Vi0 = 0; __Vi0 < 16; ++__Vi0) {
        vlSelf->tb__DOT__dut__DOT__input_state[__Vi0] = VL_RAND_RESET_I(32);
    }
    for (int __Vi0 = 0; __Vi0 < 16; ++__Vi0) {
        vlSelf->tb__DOT__dut__DOT__initial_state[__Vi0] = VL_RAND_RESET_I(32);
    }
    for (int __Vi0 = 0; __Vi0 < 16; ++__Vi0) {
        vlSelf->tb__DOT__dut__DOT__state_words[__Vi0] = VL_RAND_RESET_I(32);
    }
    for (int __Vi0 = 0; __Vi0 < 16; ++__Vi0) {
        vlSelf->tb__DOT__dut__DOT__next_state_words[__Vi0] = VL_RAND_RESET_I(32);
    }
